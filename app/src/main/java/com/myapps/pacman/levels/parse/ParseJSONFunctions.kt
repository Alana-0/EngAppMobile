package com.myapps.pacman.levels.parse
...
fun parseMapsJson(jsonString: String?): Map<Int, List<String>> {
...
fun parseLevelsJson(jsonString: String?): List<LevelStartData> {
...
fun parsePosition(jsonObject: JSONObject): Position {
    return Position(
...
fun loadAllMaps(context: Context): Map<Int, LevelStartData> {
